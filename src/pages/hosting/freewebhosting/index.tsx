...
const CardBasic = () => {
  return (
    <Grid container spacing={6}  sx={{ paddingTop: 6 }}>
      <Grid item xs={12} sx={{ paddingBottom: 4 }}>
        <Typography  variant='h3'>Web Hosting Packages</Typography>
        <Typography  variant='h5'>Full-featured, full-performance web hosting packages for every budget.</Typography>
